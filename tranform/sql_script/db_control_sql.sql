...
VALUES ('COUNT_RUNNING_ETL_LOG',
    'SELECT COUNT(*) AS running_count FROM CRAWL_LOG WHERE STATUS = ''Running''',
    'Đếm số lượng tiến trình đang ở trạng thái Running trong bảng CRAWL_LOG.');
...
INSERT INTO SQL_COMMANDS (COMMAND_NAME, SQL_QUERY, DESCRIPTION)
VALUES (
    'SELECT_PROCESS_LOG_WAITING',
    'SELECT ID FROM PROCESS_LOG WHERE ID_PROCESS = %s AND STATUS = ''WAITING'' ORDER BY START_TIME DESC LIMIT 1;',
    'Tìm process đang ở trạng thái waiting');

-- lệnh 10 
INSERT INTO SQL_COMMANDS (COMMAND_NAME, SQL_QUERY, DESCRIPTION)
VALUES (
    'UPDATE_PROCESS_LOG_RUNNING',
    'UPDATE PROCESS_LOG SET STATUS = %s WHERE ID = %s;',
    'Cập nhật trạng thái process thành running');
